...
AmanitaMuscaria::AmanitaMuscaria(shared_ptr<WorldState> currentState)
...
AmanitaMuscaria::AmanitaMuscaria(shared_ptr<WorldState> currentState,
                                 shared_ptr<ShroomTracker> sharedTracker)
...
Mushroom *AmanitaMuscaria::generateMycelium() {
  Mushroom *newShroom =
      new AmanitaMuscaria(getWorldState(), getShroomTracker());
